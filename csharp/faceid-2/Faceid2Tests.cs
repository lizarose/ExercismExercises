...
public class Faceid2Tests
{
    ...
    {
        Identity identityA = new Identity("foo@bar.com", new FacialFeatures("green", 0.9m));
        Assert.True(identityA.Equals(new Identity("foo@bar.com", new FacialFeatures("green", 0.9m))));
    }
    ...
    {
        Identity identityA = new Identity("foo@bar.com", new FacialFeatures("green", 0.9m));
        Assert.False(identityA.Equals(new Identity("foo@bar.com", new FacialFeatures("blue", 0.9m))));
    }
    //
    [Fact]
    [Task(2)]
